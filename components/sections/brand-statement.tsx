  ...
  return (
    <section className="bg-accent py-16">
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        <h2 className="font-serif text-xl sm:text-2xl lg:text-4xl font-bold text-primary-dark">
          {t({ 
        ...
        <p className="mt-4 text-sm sm:text-base lg:text-lg leading-relaxed text-primary-dark/80">
          {t({ 
